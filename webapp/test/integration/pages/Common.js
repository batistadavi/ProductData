sap.ui.define([
	...
	return Opa5.extend("northwind.ProductData.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["northwind/ProductData/localService/mockserver"], function (mockserver) {
